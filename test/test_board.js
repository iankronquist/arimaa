  ...
  describe('from game description', function() {
    ...
    describe('game 1000 tests', function() {
      ...
      it('should have the right destination positions', function() {
        expect(stepListPluck(game1000, 2, 'to')).to.deep.equal(['g3', 'd3', 'h3']);
        expect(stepListPluck(game1000, 3, 'to')).to.deep.equal(['b6', 'a6', 'f6', null, 'c6']);
        expect(stepListPluck(game1000, 4, 'to')).to.deep.equal(['g2', 'b3', 'e3', 'h4']);
        expect(stepListPluck(game1000, 5, 'to')).to.deep.equal(['g6', 'f6', null, 'd6', 'c5']);
      });
